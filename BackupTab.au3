...
If $includeBackup Then
   ...
   Global $CBX_Backup_Dummy = GUICtrlCreateCheckbox($TEXT_TAB_BACKUP_CBX_Dummy, $TAB_GROUP_LEFT + 5, $TAB_GROUP_TOP + ($CBX_HEIGHT * 1), $TAB_GROUP_WIDTH - 10, $CBX_HEIGHT)
   _ArrayAdd($BackupCheckBoxes, $CBX_Backup_Dummy)

   ;~ Check all and start actions
   Global $CBX_Backup_All = GUICtrlCreateCheckbox($TEXT_TAB_BACKUP_CBX_CheckAll, $TAB_GROUP_LEFT + 5, $CBX_CHECKALL_TOP, $TAB_GROUP_WIDTH - 10, $CBX_HEIGHT)
