...
If $includeTest Then
	...
	$CBX_Test1 = GUICtrlCreateCheckbox($TEXT_TAB_TEST_CBX_Test, $TAB_GROUP_LEFT + 5, $TAB_GROUP_TOP + ($CBX_HEIGHT * 1), $TAB_GROUP_WIDTH - 24, $CBX_HEIGHT)
	GUICtrlSetTip($hHelpIcon, "hier werden sie geholfen...")
	GUICtrlSetBkColor($CBX_Test1, 0xFF0000)
	_ArrayAdd($TestCheckBoxes, $CBX_Test1)
